...
export const dict: Dict = {
  ...
  dashboard: {
    ...
    billingPlans: {
      soloFeatures: ["Up to 5 active events", "100 GB storage", "Guest uploads with QR", "Private gallery with PIN", "Download all as ZIP"],
      proFeatures: ["Up to 25 active events", "500 GB storage", "Guest photo & video uploads", "Event cover branding", "Full moderation controls"],
